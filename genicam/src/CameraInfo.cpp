...
CameraArray::CameraArray(genicam::msg::CameraDeviceArray::SharedPtr camera_info) : Node("camera_array"), camera_info (camera_info) {
    ...
    array_pub_ = this->create_publisher<genicam::msg::CameraDeviceArray>("/caminfo", 10);
...
CameraInfo::CameraInfo(genicam::msg::CameraDeviceArray::SharedPtr camera_info) : Node("camera_info"), camera_info (camera_info) {
...
int main(int argc, char **argv) {
    ...
    genicam::msg::CameraDeviceArray::SharedPtr camera_info = std::make_shared<genicam::msg::CameraDeviceArray>();
