...
BY_MAC = { 
    ...
    # 30853686650497: [IP_LIGHT[2],   3,   "11a",    498.0,  15], #11b sticker
    # 30853686650366: [IP_LIGHT[3],   7,   "11b",    498.0,  15], #11a sticker
}
...
for camera in device_infos_no_dup:
    ...
    try:
        ...
        # config_file_path = '/home/bresilla/configs/'+ camera_name + '.txt'
        ...
        print(f"config file for camera {camera_name} created on {config_file_path}")
