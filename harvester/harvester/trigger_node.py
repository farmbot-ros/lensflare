...
def main(args=None):
    ...
    camera_group_1 = TriggerNode(inference_cameras, "inference", message=30, sequence_interval=30, inter_camera_delay=2)
    camera_group_2 = TriggerNode(acquisition_cameras, "aquisition", message=10, sequence_interval=60, inter_camera_delay=3)
    try:
